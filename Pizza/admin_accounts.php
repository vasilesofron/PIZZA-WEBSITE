...
<section class="accounts">
   ...
   <div class="box">
      <p>Adauga Administrator</p>
      <a href="admin_register.php" class="option-btn">Inregistreaza administrator</a>
   </div>
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="admin_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('Stergeti acest cont?')" class="delete-btn">sterge</a>
         <?php
   ...
   <?php
         ...
         echo '<p class="empty">Nu exista conturi valabile!</p>';
      }
   ?>
